...
@Component({
  selector: 'app-listsituationconsultation',
  templateUrl: './listsituationconsultation.component.html',
  styleUrls: ['./listsituationconsultation.component.scss']
})
export class ListsituationconsultationComponent implements OnInit,OnChanges {
