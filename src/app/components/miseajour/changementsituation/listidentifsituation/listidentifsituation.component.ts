...
@Component({
  selector: 'app-listidentifsituation',
  templateUrl: './listidentifsituation.component.html',
  styleUrls: ['./listidentifsituation.component.scss']
})
export class ListidentifsituationComponent implements OnInit {
